// Personalization templates for the $50 pitch email. Each entry returns a
...
export const EMAIL_TEMPLATES = [
  // 1 — compliment on rating
  {
    ...
    body: (b, url) =>
      ...
      `If you like it, it's yours for $50 one time — no monthly fee, no contract. Just reply and I'll hand it over.\n\n${signature}`,
  },
  ...
  // 2 — curiosity / looking-for-you
  {
    ...
    body: (b, url) =>
      ...
      `It's yours for $50 flat if you like it. If not, no hard feelings.\n\n${signature}`,
  },
  ...
  // 3 — no-pressure preview
  {
    ...
    body: (b, url) =>
      ...
      `If it's useful, you can claim it for $50 one-time. Either way, hope it's helpful.\n\n${signature}`,
  },
  ...
  // 4 — review-specific
  {
    ...
    body: (b, url) =>
      ...
      `Yours for $50 if you want it. Reply and I'll migrate it to your domain.\n\n${signature}`,
  },
  ...
  // 5 — "I made this"
  {
    ...
    body: (b, url) =>
      ...
      `If you want to keep it, $50 one-time and it's yours forever. No subscriptions.\n\n${signature}`,
  },
  ...
  // 6 — neighborhood angle (uses zip / city if present, else generic)
  {
    ...
    body: (b, url) =>
      ...
      `Preview here:\n${url}\n\n` +
      `$50 if you want to keep it. Mobile-friendly, fast, and it's yours outright.\n\n${signature}`,
  },

  // 7 — specific service / menu
  {
    id: 'service-mention',
    subject: (b) => `${b.name} — one-page site for $50`,
    body: (b, url) =>
      ...
      `If you want it, $50 one-time. Includes the design, the code, and help pointing your own domain at it.\n\n${signature}`,
  },
  ...
  // 8 — short & direct
  {
    ...
    body: (b, url) =>
      ...
      `$50 if you like it, nothing if you don't. Reply either way and I'll delete the link.\n\n${signature}`,
  },
  ...
  // 9 — gift framing
  {
    ...
    body: (b, url) =>
      ...
      `Here's the preview:\n${url}\n\n` +
      `You don't have to do anything — but if you want to keep it, it's $50 and it's all yours. No monthly fee.\n\n${signature}`,
  },
  ...
  // 10 — "why not"
  {
    ...
    body: (b, url) =>
      ...
      `Built from your real info. If you like it, $50 one-time. If not, just ignore this email.\n\n${signature}`,
  },
  ...
  // 12 — "takes 2 minutes"
  {
    ...
    body: (b, url) =>
      ...
      `$50 and it's yours. Don't like it? Just delete this email.\n\n${signature}`,
  },
  ...
  // 13 — proof-of-concept
  {
    ...
    body: (b, url) =>
      ...
      `If the site is useful, $50 and it's yours. Fair trade for the work.\n\n${signature}`,
  },
  ...
  // 14 — "saw on Maps"
  {
    ...
    body: (b, url) =>
      ...
      `$50 one-time if you want to keep it. Easy to customize later.\n\n${signature}`,
  },
  ...
  // 15 — honest / meta
  {
    ...
    body: (b, url) =>
      `Hi ${firstName(b)},\n\nQuick honest pitch: I find businesses with no website, build them one with AI, and offer it for $50. Here's yours:\n${url}\n\n` +
  ...
  // 16 — "thought you'd want this"
  {
    ...
    body: (b, url) =>
      ...
      `$50 and it's yours. Mobile-ready, includes your Google hours and location.\n\n${signature}`,
  },
  ...
  // 17 — speed framing
  {
    ...
    body: (b, url) =>
      ...
      `Your info, your hours, your location. $50 and we migrate it to your domain today.\n\n${signature}`,
  },
  ...
  // 18 — "while I was browsing"
  {
    ...
    body: (b, url) =>
      ...
      `If it works for you, $50 and you own it. Otherwise no worries, I'll take it down.\n\n${signature}`,
  },
  ...
  // 19 — "your customers will find this"
  {
    ...
    body: (b, url) =>
      ...
      `$50 and your customers have somewhere to land.\n\n${signature}`,
  },
  ...
  // 20 — low-pressure / "if ever"
  {
    ...
    body: (b, url) =>
      ...
      `$50 if you ever want to claim it. No time pressure.\n\n${signature}`,
  },
  ...
  // 22 — "we should talk"
  {
    ...
    body: (b, url) =>
      ...
      `$50 one-time if you want it. Reply and we're done.\n\n${signature}`,
  },
];
